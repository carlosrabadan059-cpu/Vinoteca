# Graph Report - Vinoteca  (2026-07-05)

## Corpus Check
- 138 files · ~93,069 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1000 nodes · 1440 edges · 86 communities (72 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8dde6694`
...
Cohesion: 0.08
Nodes (18): Animated Overlay Pattern, UI Design System (theme-driven components), Theme, AnalysisProgressProps, PHASES_ANALYZING, PHASES_IDENTIFYING, BadgeProps, ButtonProps (+10 more)

### Community 1 - "Offline-First Sync Engine"
Cohesion: 0.08
Nodes (47): Offline-First Sync Pattern, Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), WineFilters, addToQueue(), clearLocalWines() (+39 more)

### Community 2 - "Wine & Tasting Data Hooks"
Cohesion: 0.24
Nodes (7): canvas180(), captureFrameFromVideo(), CaptureSource, getUserMediaSource(), CameraAction, CameraState, CameraViewProps
...
Cohesion: 0.15
Nodes (21): callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callStatsInsight(), callWineEnrich(), callWineIdentify(), N8N_BASE (+13 more)
...
Cohesion: 0.11
Nodes (18): useTastings(), useWines(), applyFilter(), Catas(), Filter, FILTERS, SectionCardProps, TastingDetail() (+10 more)
...
Cohesion: 0.17
Nodes (13): useAuth(), Bodega(), TIPOS, WineSkeleton(), NuevaCata(), useWineStore, WineState, FieldTrace (+5 more)
...
Cohesion: 0.13
Nodes (18): Sommelier Intent Routing (maridaje/enriquecimiento/chat), callSommelierChat(), buildWineCollection(), detectIntent(), DO_KEYWORDS, extractPlato(), MARIDAJE_KEYWORDS, Sommelier() (+10 more)

## Knowledge Gaps
- **543 isolated node(s):** `Estado del proyecto`, `1. Corrección de orientación 180° (retrato invertido)`, `2. Eliminación completa del QR`, `3. Problema de caché PWA (pendiente en el dispositivo del usuario)`, `Estado actual de los archivos clave` (+538 more)
...
- **Why does `Theme` connect `UI Components & Design System` to `Offline-First Sync Engine`, `Wine & Tasting Data Hooks`, `n8n AI Integration Layer`, `Community 71`, `Scan & Camera Pipeline`, `Community 45`, `Community 83`, `Community 84`, `Community 87`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 84` to `UI Components & Design System`, `Offline-First Sync Engine`, `Community 71`, `Scan & Camera Pipeline`, `Community 45`?**
...
- **What connects `Estado del proyecto`, `1. Corrección de orientación 180° (retrato invertido)`, `2. Eliminación completa del QR` to the rest of the system?**
