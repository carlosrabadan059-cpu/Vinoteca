# Graph Report - Vinoteca  (2026-07-06)

## Corpus Check
- 138 files · ~96,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1010 nodes · 1451 edges · 93 communities (78 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e61024c`
...
Cohesion: 0.09
Nodes (46): Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), useWines(), WineFilters, addToQueue(), clearLocalWines() (+38 more)
...
Cohesion: 0.22
Nodes (9): Commits de esta sesión, Contexto de referencia, Credenciales n8n, Handoff: Vinoteca — Sesión 2026-06-10 (actualizado), Proyecto, Prueba desde móvil, Próximos pasos, Suggested skills (+1 more)
...
Cohesion: 0.26
Nodes (8): TastingState, useTastingStore, Tasting, scoreBg(), scoreColor(), TastingCard(), TastingCardProps, TastingMiniCardProps
...
Cohesion: 0.06
Nodes (47): Sommelier Intent Routing (maridaje/enriquecimiento/chat), useAuth(), callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callSommelierChat(), callStatsInsight() (+39 more)
...
Cohesion: 0.50
Nodes (4): Archivos clave, Bugs corregidos en esta sesión, Estado del frontend, Flujo de escaneo (funciona end-to-end desde móvil con HTTP)

### Community 91 - "Community 91"
Cohesion: 0.16
Nodes (9): UI Design System (theme-driven components), Theme, BadgeProps, CardProps, SuggestionChipsProps, TastingCard Component, TastingForm Component, TastingMiniCard Component (+1 more)
...
## Knowledge Gaps
- **545 isolated node(s):** `FieldStatus`, `fieldValueStyle`, `emptyValueStyle`, `SourceType`, `FieldTrace` (+540 more)
...
- **Why does `Theme` connect `Community 91` to `UI Components & Design System`, `Community 34`, `Wine & Tasting Data Hooks`, `n8n AI Integration Layer`, `Community 70`, `Community 71`, `Scan & Camera Pipeline`, `Community 45`, `Community 83`, `Community 85`, `Community 87`, `Community 88`, `Package JSON`, `Community 94`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 87` to `Offline-First Sync Engine`, `Scan & Camera Pipeline`, `Community 45`, `Community 84`, `Community 85`, `Community 88`, `Package JSON`, `Community 94`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `Scan & Camera Pipeline` to `Offline-First Sync Engine`, `Community 71`, `Community 45`, `Community 84`, `Community 87`, `Package JSON`?**
...
- **Should `ADRs & Agent Docs` be split into smaller, more focused modules?**
