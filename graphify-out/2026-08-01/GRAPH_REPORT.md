# Graph Report - Vinoteca  (2026-08-01)

## Corpus Check
- 180 files · ~131,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1426 nodes · 1913 edges · 126 communities (112 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1e7e5e2`
...
Cohesion: 0.12
Nodes (33): Offline-First Sync Pattern, Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), addToQueue(), clearLocalWines(), clearQueue() (+25 more)
...
Cohesion: 0.14
Nodes (18): App (Root Component), useProfile(), useSettings(), Ajustes(), inputStyle, ForgotPassword(), Login(), inputStyle (+10 more)
...
Cohesion: 0.13
Nodes (9): SectionCardProps, TastingDetail(), WineDetail(), ToastState, useToastStore, SpinnerProps, Toast(), ConsumoQuickForm() (+1 more)
...
Cohesion: 0.12
Nodes (16): Archivos clave, Cambios publicados en esta sesión, Commits de esta sesión, Contexto de referencia, Estado actual, Estado del workflow n8n (`EtTezN27e9tqvOjS`), Flujo actual, Flujo de escaneo (Scan.tsx) (+8 more)

### Community 47 - "Community 47"
Cohesion: 0.13
Nodes (14): Workflow n8n: vinoteca-stats-insight (ZcK7uQdi8lu3gcpa), Fix barra de navegación inferior — contraste del tab activo, OpenRouter + Gemma 3 27B Agent AI en n8n stats workflow, Archivos clave modificados esta sesión, Barra de navegación inferior (`src/components/ui/Layout.tsx`), Commits de esta sesión, Contexto de referencia, Estado actual (+6 more)
...
Cohesion: 0.13
Nodes (14): useBodegaState(), DuplicateResult, Bodega(), renderCards(), shimmerStyle, buildWineCollection(), Sommelier(), useWineStore (+6 more)
...
Cohesion: 0.17
Nodes (10): BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData, TINTOS (+2 more)

### Community 89 - "Community 89"
Cohesion: 0.18
Nodes (10): AnalysisProgress — Overlay de progreso animado durante análisis, 1. Fix scroll del modal de edición, 2. Pantalla de progreso durante el análisis del vino, Arquitectura relevante, Bloqueante pendiente: Login, Estado actual, Lo que se hizo en esta sesión, Suggested skills (+2 more)
...
Cohesion: 0.20
Nodes (9): Alcance, Criterio de finalización, Decisiones de diseño, Decisiones técnicas, Estado, Fase 11 — Optimización, Funcionalidades, Objetivo (+1 more)
...
Cohesion: 0.09
Nodes (11): BLANCOS, DecadaEntry, DECADE_ORDER, DULCES, ESPUMOSOS, EvolucionRow, MejorVino, MES_SHORT (+3 more)
...
Cohesion: 0.19
Nodes (15): useWines(), WineFilters, dataUrlToBlob(), fetchImageAsDataUrl(), storage, uploadWineImage(), supabase, supabaseAnonKey (+7 more)
...
Cohesion: 0.24
Nodes (12): injectKeyframes(), BodegaState, CURRENT_YEAR, SortKey, getSuggestions(), GROUP_OPTIONS, GroupKey, groupWines() (+4 more)
...
Cohesion: 0.17
Nodes (10): VinotecaDB, TastingState, useTastingStore, Tasting, scoreBg(), scoreColor(), TastingCard(), TastingCardProps (+2 more)

### Community 109 - "Community 109"
Cohesion: 0.27
Nodes (12): callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callStatsInsight(), callWineEnrich(), callWineIdentify(), N8N_BASE (+4 more)

### Community 110 - "Community 110"
Cohesion: 0.12
Nodes (3): StatsPayload, DistribucionEntry, eur
...
Cohesion: 0.18
Nodes (8): Sommelier Intent Routing (maridaje/enriquecimiento/chat), WineCollection, detectIntent(), DO_KEYWORDS, extractPlato(), MARIDAJE_KEYWORDS, SUGGESTIONS, SuggestionChipsProps

### Community 113 - "Community 113"
Cohesion: 0.47
Nodes (5): EditFields, scoreColor(), TastingEditForm(), TastingEditFormProps, toFields()

### Community 114 - "Community 114"
Cohesion: 0.13
Nodes (5): InputProps, emptyValueStyle, FieldStatus, fieldValueStyle, WineFormProps
...
Cohesion: 0.27
Nodes (6): canvas180(), captureFrameFromVideo(), CaptureSource, CameraAction, CameraState, CameraViewProps
...
Cohesion: 0.22
Nodes (8): EnrichResponse, FieldTrace, IdentifyResponse, Profile, SourceType, UserPlan, UserRole, UserSettings

### Community 123 - "Community 123"
Cohesion: 0.33
Nodes (6): ChatMessage, ChatBubble(), ChatBubbleProps, inlineFormat(), renderMarkdown(), ChatBubbleProps
...
Cohesion: 0.29
Nodes (5): callSommelierChat(), TastingChat Component, TASTING_CONTEXT Structured Prompt, TastingChatProps, TastingResult

## Knowledge Gaps
- **817 isolated node(s):** `eur`, `N8N_BASE`, `ScanIdentifyResponse`, `ScanResult`, `TINTOS` (+812 more)
...
- **Why does `Theme` connect `Community 91` to `Offline-First Sync Engine`, `Community 34`, `Scan & Camera Pipeline`, `Community 108`, `Community 110`, `Community 112`, `Community 113`, `Community 114`, `Community 115`, `Community 116`, `Community 85`, `Community 119`, `Package JSON`, `Community 123`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 85` to `Offline-First Sync Engine`, `Community 34`, `Community 101`, `Community 103`, `Scan & Camera Pipeline`, `Community 106`, `Community 108`, `Community 114`, `Community 115`, `Community 88`, `Package JSON`, `Community 122`, `Community 91`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Tasting` connect `Community 108` to `Offline-First Sync Engine`, `Community 101`, `Community 103`, `Community 113`, `Community 115`, `Community 88`, `Package JSON`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **What connects `eur`, `N8N_BASE`, `ScanIdentifyResponse` to the rest of the system?**
