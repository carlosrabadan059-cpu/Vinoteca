...
## Corpus Check
- 138 files · ~95,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1008 nodes · 1448 edges · 96 communities (80 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3b69f09`
...
Cohesion: 0.05
Nodes (73): useAuth(), useTastings Hook, processOperation(), useTastings(), useWines(), WineFilters, addToQueue(), clearLocalWines() (+65 more)
...
Cohesion: 0.27
Nodes (8): App (Root Component), Login(), Register(), ProtectedRoute(), router, AuthState, useAuthStore, Layout()
...
Cohesion: 0.26
Nodes (10): Offline-First Sync Pattern, Offline-First Sync Pattern, useSync(), SyncState, useSyncStore, SyncIndicator(), ACTION_LABEL, Props (+2 more)
...
Cohesion: 0.40
Nodes (3): LayoutProps, tabs, Toast()
...
Cohesion: 0.08
Nodes (34): Sommelier Intent Routing (maridaje/enriquecimiento/chat), callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callSommelierChat(), callStatsInsight(), callWineEnrich() (+26 more)
...
Cohesion: 0.32
Nodes (6): Theme, SuggestionChipsProps, TastingCard Component, TastingForm Component, TastingMiniCard Component, WineCard Component
...
Cohesion: 0.29
Nodes (3): UI Design System (theme-driven components), BadgeProps, CardProps
...
- **Why does `Theme` connect `Community 91` to `UI Components & Design System`, `Offline-First Sync Engine`, `Community 34`, `Wine & Tasting Data Hooks`, `n8n AI Integration Layer`, `Community 71`, `Scan & Camera Pipeline`, `Community 45`, `Community 83`, `Community 85`, `Community 87`, `Package JSON`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Wine` connect `Offline-First Sync Engine` to `Scan & Camera Pipeline`, `Community 45`, `Community 84`, `Community 85`, `Community 87`, `Community 94`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `useWines()` connect `Offline-First Sync Engine` to `Scan & Camera Pipeline`, `Package JSON`, `Community 45`, `Community 87`?**
