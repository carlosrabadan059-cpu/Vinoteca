# Graph Report - Vinoteca  (2026-08-03)

## Corpus Check
- 194 files · ~157,728 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1635 nodes · 2232 edges · 130 communities (116 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76833ebf`
...
Cohesion: 0.11
Nodes (21): CatasState, useCatasState(), useTastings(), useWines(), applyFilter(), FilterKey, FILTERS, wines_local IDB Store (+13 more)
...
Cohesion: 0.07
Nodes (56): Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), WineFilters, addToQueue(), clearLocalWines(), clearQueue() (+48 more)
...
Cohesion: 0.17
Nodes (7): fetchImageAsDataUrl(), ToastState, useToastStore, ModalProps, Toast(), ConsumoQuickForm(), ConsumoQuickFormProps
...
Cohesion: 0.05
Nodes (55): BodegaState, CURRENT_YEAR, useBodegaState(), useSommelier(), SortKey, getSuggestions(), GROUP_OPTIONS, GroupKey (+47 more)

### Community 110 - "Community 110"
Cohesion: 0.05
Nodes (35): BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData, TINTOS (+27 more)
...
Cohesion: 0.21
Nodes (9): VinotecaDB, TastingState, useTastingStore, Tasting, scoreBg(), scoreColor(), TastingCard(), TastingCardProps (+1 more)
...
Cohesion: 0.07
Nodes (19): Animated Overlay Pattern, ColorKey, FontSizeKey, RadiusKey, Theme, AnalysisProgressProps, PHASES_ANALYZING, PHASES_IDENTIFYING (+11 more)
...
## Knowledge Gaps
- **867 isolated node(s):** `Completadas`, `Pendientes`, `Fuera de numeración`, `Congelado`, `Principios arquitectónicos` (+862 more)
...
- **Why does `Theme` connect `Community 131` to `Community 34`, `Community 101`, `Scan & Camera Pipeline`, `Community 106`, `Community 109`, `Community 110`, `Community 112`, `Community 85`, `Community 118`, `Community 25`, `Community 125`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 25` to `Community 34`, `Community 131`, `Community 101`, `Scan & Camera Pipeline`, `Community 106`, `Community 109`, `Community 110`, `Community 112`, `Community 85`, `Community 118`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `TDD Skill` connect `README` to `ADRs & Agent Docs`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `Completadas`, `Pendientes`, `Fuera de numeración` to the rest of the system?**
