# Graph Report - Vinoteca  (2026-07-13)

## Corpus Check
- 164 files · ~120,139 words
...
## Knowledge Gaps
- **756 isolated node(s):** `FieldStatus`, `fieldValueStyle`, `emptyValueStyle`, `Fase 8 — Catas`, `Fase 7 — Gestión de Bodega` (+751 more)
...
- **What connects `FieldStatus`, `fieldValueStyle`, `emptyValueStyle` to the rest of the system?**
