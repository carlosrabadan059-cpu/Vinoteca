# Graph Report - Vinoteca  (2026-06-23)

## Corpus Check
- 127 files · ~75,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 917 nodes · 1350 edges · 79 communities (65 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ba26446`
...
Cohesion: 0.10
Nodes (13): UI Design System (theme-driven components), Theme, BadgeProps, ButtonProps, CardProps, InputProps, ModalProps, SuggestionChipsProps (+5 more)

### Community 1 - "Offline-First Sync Engine"
Cohesion: 0.12
Nodes (32): Offline-First Sync Pattern, Offline-First Sync Pattern, useTastings Hook, useSync(), addToQueue(), clearLocalWines(), clearQueue(), getDB() (+24 more)

### Community 2 - "Wine & Tasting Data Hooks"
Cohesion: 0.08
Nodes (39): Sommelier Intent Routing (maridaje/enriquecimiento/chat), useAuth(), processOperation(), useWines(), WineFilters, dataUrlToBlob(), fetchImageAsDataUrl(), storage (+31 more)
...
Cohesion: 0.08
Nodes (20): App (Root Component), BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData (+12 more)

### Community 8 - "Scan & Camera Pipeline"
Cohesion: 0.09
Nodes (30): Animated Overlay Pattern, Duplicate Wine Detection Flow, Scan Two-Phase Analysis (identify then full analyze), compressImage(), pickFile(), useCamera(), callEnriquecimiento(), callMaridaje() (+22 more)
...
Cohesion: 0.32
Nodes (5): TastingState, useTastingStore, Tasting, TastingFormProps, TastingMiniCardProps
...
## Knowledge Gaps
- **492 isolated node(s):** `N8N_BASE`, `ScanIdentifyResponse`, `ScanResult`, `PreToolUse`, `allow` (+487 more)
...
- **Why does `Theme` connect `UI Components & Design System` to `Offline-First Sync Engine`, `Wine & Tasting Data Hooks`, `Community 34`, `n8n AI Integration Layer`, `Wine Statistics Engine`, `Scan & Camera Pipeline`, `Community 45`, `TastingCard Component`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Wine` connect `Wine & Tasting Data Hooks` to `UI Components & Design System`, `Offline-First Sync Engine`, `Community 34`, `n8n AI Integration Layer`, `Wine Statistics Engine`, `Scan & Camera Pipeline`, `Community 45`, `TastingCard Component`?**
