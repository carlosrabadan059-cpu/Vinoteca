# Graph Report - Vinoteca  (2026-07-09)

## Corpus Check
- 163 files · ~119,095 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1282 nodes · 1743 edges · 115 communities (101 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3136e7f8`
...
Cohesion: 0.08
Nodes (52): Offline-First Sync Pattern, Offline-First Sync Pattern, useAuth(), useTastings Hook, processOperation(), useSync(), useWines(), WineFilters (+44 more)
...
Cohesion: 0.11
Nodes (18): Agent Domain Docs Config, Conventions, Issue tracker: GitHub, When a skill says "fetch the relevant ticket", When a skill says "publish to the issue tracker", Triage Labels, AFK Agent, Domain Glossary (Vinoteca) (+10 more)
...
Cohesion: 0.31
Nodes (7): App (Root Component), Login(), Register(), ProtectedRoute(), router, AuthState, useAuthStore
...
Cohesion: 0.14
Nodes (8): Meta, MetaSectionProps, ModeSelectorProps, NuevaCata(), QuickFormProps, TastingMode, todayISO(), SpinnerProps
...
Cohesion: 0.33
Nodes (5): Completadas, Congelado, Pendientes, Principios arquitectónicos, Roadmap — Vinoteca
...
Cohesion: 0.12
Nodes (15): Changelog — Vinoteca, Fase 1 — Captura y OCR, Fase 2 — Identificación, Fase 3 — Enriquecimiento, Fase 4 — WineForm y backend Sommelier, Fase 5 — WineForm rediseñado, Fase 6 — WineDetail rediseñado, Fase 7 — Gestión de Bodega (+7 more)
...
Cohesion: 0.15
Nodes (3): StatsPayload, Stats Insight Cache (localStorage TTL), Stats()
...
Cohesion: 0.09
Nodes (14): ColorKey, FontSizeKey, RadiusKey, Theme, BadgeProps, CardProps, ModalProps, SuggestionChipsProps (+6 more)
...
Cohesion: 0.20
Nodes (9): Alcance, Criterio de finalización, Decisiones de diseño, Decisiones técnicas, Estado, Fase 8 — Catas, Funcionalidades, Objetivo (+1 more)
...
Cohesion: 0.18
Nodes (9): BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData, TINTOS (+1 more)
...
Cohesion: 0.08
Nodes (38): Sommelier Intent Routing (maridaje/enriquecimiento/chat), callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callSommelierChat(), callStatsInsight(), callWineEnrich() (+30 more)

### Community 104 - "Community 104"
Cohesion: 0.18
Nodes (9): TastingState, useTastingStore, Tasting, scoreBg(), scoreColor(), TastingCard(), TastingCardProps, TastingFormProps (+1 more)
...
Cohesion: 0.12
Nodes (18): injectKeyframes(), BodegaState, CURRENT_YEAR, useBodegaState(), SortKey, getSuggestions(), GROUP_OPTIONS, GroupKey (+10 more)
...
Cohesion: 0.38
Nodes (6): CatasState, useCatasState(), applyFilter(), FilterKey, FILTERS, Catas()
...
Cohesion: 0.50
Nodes (3): Layout(), LayoutProps, tabs

## Knowledge Gaps
- **730 isolated node(s):** `EditFields`, `TastingEditFormProps`, `SectionCardProps`, `TastingMode`, `Meta` (+725 more)
...
- **Why does `Theme` connect `Community 91` to `Offline-First Sync Engine`, `Community 34`, `Wine & Tasting Data Hooks`, `Community 101`, `Community 103`, `Scan & Camera Pipeline`, `Community 104`, `Community 106`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 114`, `Community 85`, `Community 88`, `Package JSON`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Wine` connect `Offline-First Sync Engine` to `Community 97`, `Community 34`, `Community 103`, `Scan & Camera Pipeline`, `Community 106`, `Community 111`, `Community 112`, `Community 85`, `Package JSON`, `Community 91`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `EditFields`, `TastingEditFormProps`, `SectionCardProps` to the rest of the system?**
