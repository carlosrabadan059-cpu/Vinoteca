# Graph Report - Vinoteca  (2026-08-02)

## Corpus Check
- 189 files · ~147,808 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1591 nodes · 2185 edges · 133 communities (119 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca5646e9`
...
- `ImageCapture Component` --references--> `Theme`  [EXTRACTED]
  src/components/wine/ImageCapture.tsx → src/constants/theme.ts
...
Cohesion: 0.50
Nodes (7): processOperation(), supabase, findDuplicateWine(), generateWineUid(), normalizeWineText(), identifyByWineUid(), IdentifyResult
...
Cohesion: 0.16
Nodes (8): SectionCardProps, TastingDetail(), WineDetail(), ToastState, useToastStore, Toast(), ConsumoQuickForm(), ConsumoQuickFormProps
...
Cohesion: 0.11
Nodes (21): BodegaState, CURRENT_YEAR, SortKey, getSuggestions(), GROUP_OPTIONS, GroupKey, groupWines(), SORT_OPTIONS (+13 more)

### Community 27 - "README"
Cohesion: 0.11
Nodes (11): Red-Green-Refactor Loop, Tracer Bullet Vertical Slice, Deep Modules, Interface Design for Testability, Designing for Mockability, When to Mock, Refactor Candidates, TDD Skill (+3 more)
...
Cohesion: 0.17
Nodes (20): Offline-First Sync Pattern, useSync(), getQueue(), getQueueCount(), removeFromQueue(), updateQueueItem(), processOperation(), syncQueue() (+12 more)
...
Cohesion: 0.16
Nodes (12): buildTasteProfile(), TasteProfile, classifyWine(), supabaseAnonKey, supabaseUrl, AuthState, FieldTrace, Profile (+4 more)
...
Cohesion: 0.17
Nodes (12): useBodegaState(), useWines(), wines_local IDB Store, Bodega(), Meta, MetaSectionProps, ModeSelectorProps, NuevaCata() (+4 more)
...
Cohesion: 0.05
Nodes (51): compressImage(), pickFile(), useCamera(), useSommelier(), getUserMediaSource(), callEnriquecimiento(), callMaridaje(), callScanAnalizar() (+43 more)
...
Cohesion: 0.11
Nodes (12): ColorKey, FontSizeKey, RadiusKey, Theme, BadgeProps, CardProps, ModalProps, SuggestionChipsProps (+4 more)

### Community 115 - "Community 115"
Cohesion: 0.10
Nodes (7): ButtonProps, InputProps, TastingFormProps, emptyValueStyle, FieldStatus, fieldValueStyle, WineFormProps
...
Cohesion: 0.29
Nodes (4): dataUrlToBlob(), fetchImageAsDataUrl(), storage, uploadWineImage()
...
## Knowledge Gaps
- **835 isolated node(s):** `Estado`, `Objetivo`, `Alcance`, `Funcionalidades`, `Decisiones de diseño` (+830 more)
...
- **Why does `Theme` connect `Community 114` to `Community 34`, `Community 131`, `Community 101`, `Scan & Camera Pipeline`, `Community 109`, `Community 110`, `Community 115`, `Community 116`, `Community 85`, `Community 118`, `Community 25`, `Community 125`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 25` to `Community 1`, `Community 34`, `Community 101`, `Scan & Camera Pipeline`, `Community 106`, `Community 109`, `Community 110`, `Community 114`, `Community 115`, `Community 116`, `Community 91`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `supabase` connect `Community 1` to `Community 130`, `Community 34`, `Community 101`, `Community 106`, `Community 110`, `Community 85`, `Community 91`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **What connects `Estado`, `Objetivo`, `Alcance` to the rest of the system?**
