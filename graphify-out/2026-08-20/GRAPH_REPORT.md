...
## Corpus Check
- 239 files · ~172,124 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1668 nodes · 2272 edges · 135 communities (121 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9df5e02e`
...
- `Stats()` --conceptually_related_to--> `Offline-First Sync Pattern`  [INFERRED]
  src/pages/Stats.tsx → src/store/syncStore.ts
...
Cohesion: 0.08
Nodes (16): Animated Overlay Pattern, ColorKey, FontSizeKey, RadiusKey, Theme, AnalysisProgressProps, PHASES_ANALYZING, PHASES_IDENTIFYING (+8 more)
...
Cohesion: 0.15
Nodes (14): TastingState, useTastingStore, Tasting, scoreBg(), scoreColor(), TastingCard(), TastingCardProps, EditFields (+6 more)
...
Cohesion: 0.07
Nodes (57): Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), WineFilters, addToQueue(), clearLocalWines(), clearQueue() (+49 more)
...
Cohesion: 0.14
Nodes (12): useWines(), wines_local IDB Store, fetchImageAsDataUrl(), SectionCardProps, TastingDetail(), WineDetail(), ToastState, useToastStore (+4 more)
...
Cohesion: 0.06
Nodes (31): BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData, TINTOS (+23 more)
...
Cohesion: 0.40
Nodes (7): CatasState, useCatasState(), useTastings(), applyFilter(), FilterKey, FILTERS, Catas()
...
Cohesion: 0.12
Nodes (22): BodegaState, CURRENT_YEAR, useBodegaState(), SortKey, getSuggestions(), GROUP_OPTIONS, GroupKey, groupWines() (+14 more)
...
Cohesion: 0.05
Nodes (46): useSommelier(), callAyudaChat(), callEnriquecimiento(), callImprovePhoto(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callSommelierChat() (+38 more)
...
Cohesion: 0.11
Nodes (21): App (Root Component), injectKeyframes(), useProfile(), useSettings(), Ajustes(), inputStyle, ForgotPassword(), Login() (+13 more)
...
## Knowledge Gaps
- **888 isolated node(s):** `PasswordInputProps`, `inputStyle`, `Considered Options`, `Contexto`, `Decisión` (+883 more)
...
- **Why does `Theme` connect `Community 25` to `Community 129`, `Community 34`, `Community 101`, `Community 106`, `Community 110`, `Community 112`, `Community 115`, `Community 85`, `Community 118`, `Community 121`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 121` to `Community 129`, `Community 101`, `Community 106`, `Community 110`, `Community 112`, `Community 115`, `Community 85`, `Community 118`, `Community 25`, `Community 123`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Tasting` connect `Community 34` to `Community 101`, `Community 110`, `Community 115`, `Community 85`, `Community 25`, `Community 123`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **What connects `PasswordInputProps`, `inputStyle`, `Considered Options` to the rest of the system?**
