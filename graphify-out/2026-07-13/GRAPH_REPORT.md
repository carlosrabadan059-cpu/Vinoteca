...
## Corpus Check
- 164 files · ~120,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1318 nodes · 1778 edges · 119 communities (104 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc32216a`
...
Cohesion: 0.08
Nodes (48): Offline-First Sync Pattern, Offline-First Sync Pattern, useTastings Hook, processOperation(), useSync(), useWines(), WineFilters, addToQueue() (+40 more)
...
Cohesion: 0.14
Nodes (9): SectionCardProps, TastingDetail(), WineDetail(), ToastState, useToastStore, ModalProps, Toast(), ConsumoQuickForm() (+1 more)
...
Cohesion: 0.10
Nodes (12): ColorKey, FontSizeKey, RadiusKey, Theme, BadgeProps, CardProps, SuggestionChipsProps, TastingForm Component (+4 more)
...
Cohesion: 0.15
Nodes (11): BLANCOS, classifyWine(), DULCES, ESPUMOSOS, MES_SHORT, ROSADOS, StatsData, TINTOS (+3 more)
...
Cohesion: 0.14
Nodes (14): VinotecaDB, TastingState, useTastingStore, EnrichResponse, FieldTrace, IdentifyResponse, SourceType, Tasting (+6 more)
...
Cohesion: 0.15
Nodes (17): injectKeyframes(), useAuth(), BodegaState, CURRENT_YEAR, useBodegaState(), SortKey, getSuggestions(), GROUP_OPTIONS (+9 more)
...
Cohesion: 0.25
Nodes (13): callEnriquecimiento(), callMaridaje(), callScanAnalizar(), callScanIdentificar(), callSommelierChat(), callStatsInsight(), callWineEnrich(), callWineIdentify() (+5 more)
...
Cohesion: 0.21
Nodes (6): DuplicateResult, WineState, Wine, DuplicateWineDialogProps, TYPE_LABELS, WineCardProps
...
## Knowledge Gaps
- **756 isolated node(s):** `Fase 8 — Catas`, `Fase 7 — Gestión de Bodega`, `Fase 6 — WineDetail rediseñado`, `Fase 5 — WineForm rediseñado`, `Fase 4 — WineForm y backend Sommelier` (+751 more)
...
- **Why does `Theme` connect `Community 91` to `Offline-First Sync Engine`, `Community 34`, `Wine & Tasting Data Hooks`, `Community 101`, `Community 103`, `Scan & Camera Pipeline`, `Community 104`, `Community 106`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 114`, `Community 115`, `Community 85`, `Community 88`, `Package JSON`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Wine` connect `Community 114` to `Community 97`, `Offline-First Sync Engine`, `Community 34`, `Community 103`, `Community 104`, `Scan & Camera Pipeline`, `Community 106`, `Community 111`, `Community 112`, `Community 115`, `Community 85`, `Package JSON`, `Community 91`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Tasting` connect `Community 104` to `Community 97`, `Offline-First Sync Engine`, `Community 103`, `Community 111`, `Community 113`, `Package JSON`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `Fase 8 — Catas`, `Fase 7 — Gestión de Bodega`, `Fase 6 — WineDetail rediseñado` to the rest of the system?**
